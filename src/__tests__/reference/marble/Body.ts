...
export class Body {
	...
	getVelocityAt(r: Vec2Like): Vec2Like {
		return this.velocity.clone().add({ x: -this.angularVelocity * r.y, y: this.angularVelocity * r.x });
	}
	 ...
	 *
	 * @param force 真の時、常に更新する。
	 */
	_updateTransform(force = false): void {
